        ...
        <footer className="bg-gray-900 text-white py-12 px-4">
            <div className="container  max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-4 gap-8">
                    ...
                    <div className="mb-8 md:mb-0">
                        ...
                        <p className="text-gray-400 mt-2">
                            Join us on our journey to inspire and empower through insightful content and community engagement.
                        </p>
                    </div>
                    ...
                    <div className="mb-8 md:mb-0">
                        ...
                        <p className="text-gray-400 mb-4">
                            Stay updated with our latest news and articles. Subscribe to our newsletter!
                        </p>
                        <form className="flex">
                            <input
                                type="email"
                            ...
                            />
                            <button className="bg-blue-600 text-white p-2 rounded-r-md hover:bg-blue-700 transition duration-300">
                                Subscribe
                            </button>
                        </form>
                    </div>
                ...
                <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400">
                    <p>&copy; {new Date().getFullYear()} Sushil Blog. All rights reserved.</p>
                </div>
            </div>
        </footer>
    );
